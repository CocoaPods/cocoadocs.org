  ...
  describe Specification do
    describe 'or extensions' do
      ...
      describe 'license name and url extension' do
        ...
        it 'should detect the Apache 2 license for Apache 2' do
       ...
       it 'should detect the Apache 2 license for Apache2' do
          @spec.stubs(:license).returns({ :type => 'Apache2' })
          @spec.or_license_name_and_url.should == { :license => 'Apache 2', :url => 'https://www.apache.org/licenses/LICENSE-2.0.html'}
       end

       it 'should detect the Apache 2 license for Apache 2.0' do
          @spec.stubs(:license).returns({ :type => 'Apache 2.0' })
          @spec.or_license_name_and_url.should == { :license => 'Apache 2', :url => 'https://www.apache.org/licenses/LICENSE-2.0.html'}
       end

       it 'should detect the Apache 2 license for Apache License, Version 2' do
          @spec.stubs(:license).returns({ :type => 'Apache License, Version 2' })
          @spec.or_license_name_and_url.should == { :license => 'Apache 2', :url => 'https://www.apache.org/licenses/LICENSE-2.0.html'}
       end
